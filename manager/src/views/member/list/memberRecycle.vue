        ...
        <Row @keydown.enter.native="handleSearch">
          <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
            <Form-item label="Username" prop="username">
              <Input type="text" v-model="searchForm.username" placeholder="Please enter username" clearable style="width: 200px" />
            </Form-item>

            <Form-item label="Phone" prop="mobile">
              <Input type="text" v-model="searchForm.mobile" placeholder="Please enter user phone" clearable style="width: 200px" />
            </Form-item>
...
export default {
  ...
  methods: {
    ...
    enable(v) {
      ...
      this.$Modal.confirm({
        title: "Confirm",
        content: "<p>Enable this membership?</p>",
        onOk: () => {
