<template>
  <div class="layout">
    <Form ref="formValidate" :label-width="250" label-position="right" :model="formValidate" :rules="ruleValidate">
      <FormItem label="Product Review" prop="goodsCheck">
      ...
      <div class="label-item">
        <FormItem class="label-item" label="Thumbnail Width" prop="abbreviationPictureWidth">
        ...
        <FormItem class="label-item" label="Thumbnail Height" prop="abbreviationPictureHeight">
      ...
      <div class="label-item">
        <FormItem label="Small Image Width" prop="smallPictureWidth">
        ...
        <FormItem label="Small Image Height" class="label-item" prop="smallPictureHeight">
      ...
      <div class="label-item">
        <FormItem class="label-item" label="Original Image Width" prop="originalPictureWidth">
        ...
        <FormItem class="label-item" label="Original Image Height" prop="originalPictureHeight">
      ...
      <div class="label-btns">
        ...
        <Button type="primary" style="margin-left: 100px" @click="createIndex()">Rebuild all product indexes</Button>
